...
| 9 | Sản phẩm | đưa quyết định tới người dùng | web app + dashboard, 27/27 và 12/12 acceptance | mục 9 của Sprint 3 |
...
- web app FastAPI + SPA không CDN, 27/27 acceptance trình duyệt;
