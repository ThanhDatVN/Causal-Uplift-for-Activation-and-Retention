...
[`../webapp/`](../webapp/) — API FastAPI và giao diện SPA không CDN, `27/27` acceptance
...
| 9 — sản phẩm, tầng nhắm mục tiêu | **Chạy được**, `27/27` và `12/12` acceptance. Đã qua vòng thiết kế đầu tiên | Mục 5.2 |
