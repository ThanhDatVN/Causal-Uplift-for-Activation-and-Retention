...
[`../webapp/`](../webapp/) — API FastAPI và giao diện SPA không CDN, `23/23` acceptance
...
| 9 — sản phẩm, tầng nhắm mục tiêu | **Chạy được**, `23/23` và `12/12` acceptance. **Chưa qua một vòng thiết kế nào** | Mục 5.2 |
