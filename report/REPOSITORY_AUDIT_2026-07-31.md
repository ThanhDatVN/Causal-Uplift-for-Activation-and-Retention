...
- liên kết nội bộ và 73 URL ngoài;
...
| Internal Markdown links | 59 link, 0 broken |
| CSV duplicate header | 0 sau khi sửa Sprint 1 arm summary |
| External URL | 73 checked sau khi bổ sung research plan |
...
| Trackable repository size | khoảng 1,38 MB/119 file trước commit |

53 URL trả 200. Một số DOI/publisher trả 403, ReadTheDocs trả 429; DOI của *An
Introduction to the Bootstrap* có một lần trả 404 sau redirect dù lần kiểm tra trước trả 200
và resolver vẫn trỏ về Taylor & Francis; DOI AAAI 2026 có một lần đóng connection. Các
trường hợp này không được tự coi là link hỏng. Các nguồn phương pháp chính đã được mở lại
qua DOI, proceedings, journal page hoặc official documentation khi research plan.
